...
from cord19.trainer_utils import DocRelTrainerHelper, DocRelDataCollator, get_label_classes_from_nlp_dataset, \
    get_vectors_from_spacy_model, get_non_empty_text_from_doc
from datasets.cord19_docrel.cord19_docrel import get_train_split, get_test_split
...
def main():
    ...
    print("NLP DAtaset : ",experiment_args.nlp_dataset)
    ...
    if model_args.model_name_or_path.startswith('baseline-rnn'):
        ...
        if 'longformer' in model_args.model_name_or_path:
            ...
            # override max length
            experiment_args.max_length = 512
